...
export function AgentSummary({ name, uuid, description, imageUrl, roleName, ...rest }: AgentSummaryProps) {
  return (
    <article className="flex flex-col items-center text-center mx-auto gap-8" {...rest} >
      <header>
      ...
      <main className="flex flex-col items-center gap-1 max-w-xs sm:max-w-lg" >
        ...
        <span className="text-sm font-bold text-brand-white-400" >{roleName}</span>
